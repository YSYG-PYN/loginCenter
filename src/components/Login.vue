    ...
    <div class="login_container">
        ...
        <el-form :model="loginForm" :rules="loginFormRules" ref="loginFormRef" class="login_form">
            ...
            <el-form-item label="" prop="code">
                <el-input class="code" v-model="code" placeholder="请输入图片验证码">
  ...
  methods: {
    ...
    login () {
      ...
      this.$refs.loginFormRef.validate(valid => {
        ...
        formData.append('grant_type', this.loginForm.grant_type)
        this.$http.post('/apis/loginCenter/oauth/token', formData, { headers: headers }).then(response => {
          console.log(response)
          if (response.status !== 200) return this.$message.error('登录失败')
